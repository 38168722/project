...
SECRET_KEY = '52y-!ygtewdilb$0qr7^7@hckh4&-r$d-2j8nup(96vem=q)dt'
...
MIDDLEWARE = [
    ...
    # 'app01.middlewares.rbac.RbacMiddleware'
...
#ALID_URL=['/admin.*','/login/','/blog/*','/register/','/getvalicode/','/index/','/media/','/cate/*','/poll/','/test01/','/mommentttt/']
