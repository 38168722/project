# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-12-20 02:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(1, '男'), (2, '女'), (3, '人妖')], verbose_name='性别')),
                ('depart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app04.Department', verbose_name='所属部门')),
                ('roles', models.ManyToManyField(to='app04.Role', verbose_name='扮演角色')),
            ],
        ),
    ]
